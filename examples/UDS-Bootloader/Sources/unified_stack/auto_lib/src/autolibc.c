 ...
 * Rule is violated because array indexing is used on pointer. This pointer can
 *not be defined as an array because it receives the value from the function
 *argument. Working directli with the argument would make the code less
 *readable.
 *
 * * @section AutoLibc_REF_9
 * Violates MISRA 2004 Required Rule 16.8, All exit paths from a function with
 *non-void return type shall have an explicit return statement with an
 *expression. Program flow will never rech that point. Program will return from
 *the endless loop.
 *
 ** @section AutoLibc_REF_10
 * Violates MISRA 2004 Required Rule 17.2, Pointer subtraction shall only be
 *applied to pointers that address elements of the same array. Pointers address
...
/*==============================================================================
 ...
 ==============================================================================*/
static INLINE int32_t fsl_memcmp_aux(const void *pcoavMemA1, const void *pcoavMemB1, uint32_t u32Size1);
/*==============================================================================
 LOCAL FUNCTIONS
 ==============================================================================*/
/*
...
static INLINE int32_t fsl_memcmp_aux(const void *pcoavMemA1, const void *pcoavMemB1, uint32_t u32Size1) {
	...
	for (u32Ctr1 = 0U; u32Ctr1 < u32Size1; u32Ctr1++) {
		...
		CA_Check2(&pcoau8MemA1[u32Ctr1], &pcoau8MemB1[u32Ctr1], sizeof(*pcoau8MemA1));
#endif
		/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
...
void *fsl_memcpy(void *pavDest2, const void *pcoavSource2, uint32_t u32Length2) {
	...
	if (u32Length2 < MEMCPY_OPT_LENGTH) {
		for (u32Ctr2 = 0U; u32Ctr2 < u32Length2; u32Ctr2++) {
			...
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			CA_Check2(&pau8Dst2[u32Ctr2], &pcoau8Src2[u32Ctr2], sizeof(*pau8Dst2));
#endif
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			pau8Dst2[u32Ctr2] = pcoau8Src2[u32Ctr2];
		}
	} else { /* optimized copying */
		u32Ctr2 = 0U;
		/* Compute offset between pointers. We are only interested in last 2
		 * bits, so uint8_t is enough */
		/* warning - convertion to smaller type (lost of higher bytes) -
		...
		/* Check whether offset between pointers is multiple of 4 (last 2 bits
		 * are zero) */
		if (0U == (u8ShiftDif & 3U)) { /* copy along 4B */
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Afvisory Rule 11.3 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			while (0U != (((uaddr_t)(&pau8Dst2[u32Ctr2])) & 3U)) { /* copy first unaligned part of data */
#ifdef AUTOLIB_TESTING
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				CA_Check2(&pau8Dst2[u32Ctr2], &pcoau8Src2[u32Ctr2], sizeof(*pau8Dst2));
			...
			for (u32Ctr2 = 0U; u32Ctr2 < u32IntCount2; u32Ctr2++) {
				...
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				CA_Check2((uint8_t *)&pau32Dst2[u32Ctr2], (const uint8_t *)&pcoau32Src2[u32Ctr2], sizeof(*pau32Dst2));
#endif
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
		...
		/* Check whether offset between pointers is multiple of 2 (last 1 bit is
		 zero) */
		else if (0U == (u8ShiftDif & 1U)) { /* Copy along 2B */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			if (0U != (((uaddr_t)(&pau8Dst2[u32Ctr2])) & 1U)) { /* copy first unaligned part of data */
#ifdef AUTOLIB_TESTING
				/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3
				 */
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
			...
			for (u32Ctr2 = 0U; u32Ctr2 < u32IntCount2; u32Ctr2++) {
				...
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				CA_Check2((uint8_t *)&pau16Dst2[u32Ctr2], (const uint8_t *)&pcoau16Src2[u32Ctr2], sizeof(*pau16Dst2));
#endif
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
			...
			for (u32Ctr2 = 0U; u32Ctr2 < u32Length2; u32Ctr2++) {
				...
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				CA_Check2((uint8_t *)&pau8Dst2[u32Ctr2], (const uint8_t *)&pcoau8Src2[u32Ctr2], sizeof(*pau8Dst2));
#endif
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				pau8Dst2[u32Ctr2] = pcoau8Src2[u32Ctr2];
...
void *fsl_memset(void *pavDest3, uint8_t u8Fill3, uint32_t u32Length3) {
	...
	if (u32Length3 < MEMSET_OPT_LENGTH) {
		for (u32Ctr3 = 0U; u32Ctr3 < u32Length3; u32Ctr3++) {
			...
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			CA_Check1(&pau8Dst3[u32Ctr3], sizeof(*pau8Dst3));
#endif
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
	...
	/* optimized code */
		...
		/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
		/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
		while (0U != ((uaddr_t)(&pau8Dst3[u32Ctr3]) & 3U)) { /* set first unaligned bytes */
#ifdef AUTOLIB_TESTING
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			CA_Check1(&pau8Dst3[u32Ctr3], sizeof(*pau8Dst3));
		...
		for (u32Ctr3 = 0U; u32Ctr3 < u32IntCount3; u32Ctr3++) {
			...
			/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required Rule 11.4 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			CA_Check1((uint8_t *)&pau32Dst3[u32Ctr3], sizeof(*pau32Dst3));
#endif
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
...
void *fsl_memmove(void *pavDest4, const void *pcoavSource4, uint32_t u32Length4) {
	...
	if (pavDest4 == pcoavSource4) { /* Both buffers are same */
		;							/* Nothing to copy, it is already done */
	}
	/** @violates @ref AutoLibc_REF_10 MISRA 2004 Required Rule 17.2 */
	else if (pavDest4 < pcoavSource4) { /* Source start possibly overlaps the destination
	 end which means the start of the pcoavSource4
	 could be overwritten. It is save to copy from
	 the beginning, which is what memcpy does. */
		/* MISRA NOTE: the return value does not contain error information */
		fsl_memcpy(pavDest4, pcoavSource4, u32Length4);
	} else { /* Destination start possibly overlaps the end of source which
	 means the end of the source could be overwritten. It is safe to
	 copy from the end. */
...
#ifdef AUTOLIB_TESTING
				CA_Check2(pu8AfterDst4, pcou8AfterSrc4, sizeof(*pu8AfterDst4));
#endif
			}
		}
		/* optimized copying */
		else {
			/* warning - conversion to smaller type (lost of higher bytes) -
			 * required behaviour here */
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			u8ShiftDif = (uint8_t)((uaddr_t)pavDest4 - (uaddr_t)pcoavSource4);
			/* Check whether offset between pointers is multiple of 4 (last 2
			 * bits are zero) */
			if (0U == (u8ShiftDif & 3U)) { /* move along 4B */
				/* align the end of Dst to uint32_t size, copy bytes (if any) */
				/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3
				 */
				while (0U != ((uaddr_t)pu8AfterDst4 & 3U)) { /* 0 != (address % 4U), address not aligned to 4 */
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					pu8AfterDst4--;
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
				...
				/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3
				 */
				while ((uaddr_t)pu32AfterDst4 >= ((uaddr_t)pu8FirstDst4 + 4U)) { /* --AfterDst >= FirstDst, syntax above
			   prevents underflow */
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					pu32AfterDst4--;
...
#ifdef AUTOLIB_TESTING
					/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required
					 * Rule 11.3 */
					/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required
					 * Rule 11.4 */
					CA_Check2((uint8_t *)pu32AfterDst4, (const uint8_t *)pcou32AfterSrc4, sizeof(*pu32AfterDst4));
#endif
				}
			...
			/* 2B shift between destination and source data addresses */
				...
				/* move along 2B */
				/* Align the end of Dst to uint16_t size, copy even byte (if
				 * any) */
				/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3
				 */
				if (0U != ((uaddr_t)pu8AfterDst4 & 1U)) { /* 0 != (address % 4U), address not aligned to 4 */
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					pu8AfterDst4--;
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
				...
				/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3
				 */
				while ((uaddr_t)pu16AfterDst4 >= ((uaddr_t)pu8FirstDst4 + 2U)) { /* --AfterDst >= FirstDst, syntax above
			   prevents underflow */
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					pu16AfterDst4--;
					...
					*pu16AfterDst4 = *pcou16AfterSrc4;
					...
					/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required
					 * Rule 11.4 */
					CA_Check2((uint8_t *)pu16AfterDst4, (const uint8_t *)pcou16AfterSrc4, sizeof(*pu16AfterDst4));
#endif
				}
 ...
 * @details Function returns difference between the first not matching
 * characters or zero if data in blocks are identical. Compare operation is
 * optimized for all alignment of source or destination memory blocks.
 *
		...
		if (0U == (u8ShiftDif & 3U)) {
			...
			if (0 == s32Result5) {
				...
				for (u32Ctr5 = 0U; u32Ctr5 < u32IntCount5; u32Ctr5++) {
					...
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					CA_Check2((const uint8_t *)&pcoau32MemA5[u32Ctr5], (const uint8_t *)&pcoau32MemB5[u32Ctr5],
							  sizeof(*pcoau32MemA5));
#endif
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					if (pcoau32MemA5[u32Ctr5] != pcoau32MemB5[u32Ctr5]) {
						...
						s32Result5 = fsl_memcmp_aux((const void *)(&pcoau32MemA5[u32Ctr5]),
													(const void *)(&pcoau32MemB5[u32Ctr5]), 4U);
						break;
					}
				}
				...
				if (0 == s32Result5) {
					 ...
					 * Rule 17.4 */
					s32Result5 = fsl_memcmp_aux((const void *)(&pcoau32MemA5[u32Ctr5]),
												(const void *)(&pcoau32MemB5[u32Ctr5]), u32Size5);
				}
			}
		}
		/* 2B shift between destination and source data addresses */
			...
			if (0U == u32FirstBytes5) {
				...
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				CA_Check2((const uint8_t *)pcoavMemA5, (const uint8_t *)pcoavMemB5,
			...
			if (0 == s32Result5) {
				...
				/* u32Size5 is at least 26 so this loop always proceeds at least
				 * once time */
				for (u32Ctr5 = 0U; u32Ctr5 < u32IntCount5; u32Ctr5++) {
#ifdef AUTOLIB_TESTING
					/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required
					...
					/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required
					 * Rule 11.4 */
					CA_Check2((const uint8_t *)pcoau16MemA5, (const uint8_t *)pcoau16MemB5, sizeof(*pcoau16MemB5));
#endif
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					if (pcoau16MemA5[u32Ctr5] != pcoau16MemB5[u32Ctr5]) {
						...
						s32Result5 = fsl_memcmp_aux((const void *)(&pcoau16MemA5[u32Ctr5]),
													(const void *)(&pcoau16MemB5[u32Ctr5]), 2U);
						break;
					}
				}
				/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required Rule 11.4
				...
				if (0 == s32Result5) {
					 ...
					 * Rule 17.4 */
					s32Result5 = fsl_memcmp_aux((const void *)(&pcoau16MemA5[u32Ctr5]),
												(const void *)(&pcoau16MemB5[u32Ctr5]), u32Size5);
				}
			}
		}
		/* any other shifting */
 ...
 *          into the destination string. If the source string is shorter than
 * the requested characters number then the remaining characters in the
 *          destination string are set to the null character. If source string
 * is longer than requested characters number then the destination string will
 * not contain the terminating null character. This operation is optimized for
 * all alignment of source or destination string.
 *
...
char_t *fsl_strncpy(char_t *pszDest7, const char_t *pcoszSrc7, uint32_t u32Length7) {
	...
	if (u32Length7 < STRNCPY_OPT_LENGTH) {
		for (u32Ctr7 = 0U; u32Ctr7 < u32Length7; u32Ctr7++) {
			...
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			CA_Check2(&pau8Dst7[u32Ctr7], &pcoau8Src7[u32Ctr7], sizeof(*pau8Dst7));
#endif
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
	...
	/* optimized copying */
		...
		/* Check whether offset between pointers is multiple of 4 (last 2 bits
		 * are zero) */
		if (0U == (u8ShiftDif & 3U)) { /* copying along 4B */
			...
			if (0U == u32WriteZeroes7) {
				while (u32Ctr7 < u32IntCount7) {
					...
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					CA_Check2((uint8_t *)&pau32Dst7[u32Ctr7], (const uint8_t *)&pcoau32Src7[u32Ctr7],
							  sizeof(*pau32Dst7));
#endif
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					if ((0U == (pcoau32Src7[u32Ctr7] & 0xFF000000U)) || (0U == (pcoau32Src7[u32Ctr7] & 0x00FF0000U)) ||
						(0U == (pcoau32Src7[u32Ctr7] & 0x0000FF00U)) ||
						(0U == (pcoau32Src7[u32Ctr7] & 0x000000FFU))) { /* terminating '\0' found, which
					  byte? Start writing '\0' */
						/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required
						 * Rule 11.4 */
						/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
						 * Rule 17.4 */
						...
						for (u32TempCtr7 = 0U; u32TempCtr7 < UINT_SIZE; u32TempCtr7++) {
#ifdef AUTOLIB_TESTING
							/** @violates @ref AutoLibc_REF_3 MISRA 2004
							 * Required Rule 11.3 */
							/** @violates @ref AutoLibc_REF_7 MISRA 2004
							 * Required Rule 17.4 */
							CA_Check2(&pau8TempDst7[u32TempCtr7], &pcoau8TempSrc7[u32TempCtr7], sizeof(*pau8TempDst7));
#endif
							if (1U == u32WriteZeroes7) {
								/** @violates @ref AutoLibc_REF_7 MISRA 2004
								 * Required Rule 17.4 */
							...
							/** @violates @ref AutoLibc_REF_7 MISRA 2004
							 Required Rule 17.4 */
								...
								/** @violates @ref AutoLibc_REF_7 MISRA 2004
								 * Required Rule 17.4 */
								pau8TempDst7[u32TempCtr7] = pcoau8TempSrc7[u32TempCtr7];
							}
						}
			...
			while (u32Ctr7 < u32IntCount7) {
				...
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				CA_Check2((uint8_t *)&pau32Dst7[u32Ctr7], (const uint8_t *)&pcoau32Src7[u32Ctr7], sizeof(*pau32Dst7));
#endif
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
		...
		/* 2B shift between destination and source data addresses */
		else if (0U == (u8ShiftDif & 1U)) { /* copying along 2B */

			/* if there is one unaligned byte */
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			if (0U != ((uaddr_t)(&pau8Dst7[u32Ctr7]) & 1U)) { /* 0 != (address % 2U), address not aligned to 2 */
#ifdef AUTOLIB_TESTING
				/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3
				 */
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
			...
			if (0U == u32WriteZeroes7) {
				while (u32Ctr7 < u16IntCount7) {
					...
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					CA_Check2((uint8_t *)&pau16Dst7[u32Ctr7], (const uint8_t *)&pcoau16Src7[u32Ctr7],
							  sizeof(*pau16Dst7));
#endif
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					if ((0U == (pcoau16Src7[u32Ctr7] & 0xFF00U)) || (0U == (pcoau16Src7[u32Ctr7] & 0x00FFU))) { /* terminating
																  '\0' found, which byte? Start writing '\0' */
						/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required
						 * Rule 11.4 */
						/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
						 * Rule 17.4 */
			...
			while (u32Ctr7 < u16IntCount7) {
				...
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				CA_Check2((uint8_t *)&pau16Dst7[u32Ctr7], (const uint8_t *)&pcoau16Src7[u32Ctr7], sizeof(*pau16Dst7));
#endif
			...
			if (0U != u32Length7) {
#ifdef AUTOLIB_TESTING
				CA_Check2(pau8Dst7, pcoau8Src7, sizeof(*pau8Dst7));
#endif
				if (1U == u32WriteZeroes7) {
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
 ...
 * @details Function returns difference between the first not matching
 * characters or zero if strings are identical. This operation is optimized for
 * all alignment of source or destination string.
 * @param[in] pcoszStrA6 The first string to compare
 * @param[in] pcoszStrB6 The second string to compare
 * @return Result of (*pcoszStrA6 - *pcoszStrB6) when the not matching character
 * is found. Value 0 means that both strings are equal.
...
int32_t fsl_strcmp(const char_t *pcoszStrA6, const char_t *pcoszStrB6) {
	...
	CA_SetRange2() */
#endif
	/* warning - convertion to smaller type (lost of higher bytes) - required
	 * behaviour here */
	/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
	/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
	u8ShiftDif = (uint8_t)((uaddr_t)pcoszStrB6 - (uaddr_t)pcoszStrA6);
	/* Check whether offset between pointers is multiple of 4 (last 2 bits are
	 * zero) */
	if (0U == (u8ShiftDif & 3U)) { /* comparing along 4B */

		/* first unaligned bytes */
		/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
		/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
		while (0U != ((uaddr_t)(&pcoau8StrA6[u32Ctr6]) & 3U)) { /* 0 != (address % 4U), address not aligned to 4 */
#ifdef AUTOLIB_TESTING
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			CA_Check2(&pcoau8StrA6[u32Ctr6], &pcoau8StrB6[u32Ctr6], sizeof(*pcoau8StrA6));
#endif
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
		...
		/* It is difficult and/or ineffective to construct single condition and
		 * it would be difficult to understand the condition. We are using
		 * multiple return statements to exit the loop instead.It is the most
		 * straight forward and error proof method in this case. The cause is,
		 * that we are iterating by integers, but checking by bytes and there
		 * are 2 different possible outcomes.
		 * The loop is running till zero byte or non-matching bytes are found.
		 */
		/** @violates @ref AutoLibc_REF_6 MISRA 2004 Required Rule 13.7 */
		for (u32Ctr6 = 0U; 1 == 1; u32Ctr6++) { /* multiple return statements
		 are used to leave the loop */

#ifdef AUTOLIB_TESTING
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required Rule 11.4 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			CA_Check2((const uint8_t *)&pcoau32StrA6[u32Ctr6], (const uint8_t *)&pcoau32StrB6[u32Ctr6],
					  sizeof(*pcoau32StrA6));
#endif
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			if (pcoau32StrA6[u32Ctr6] != pcoau32StrB6[u32Ctr6]) { /* there is at least 1 not matching
			 byte */
				...
				for (u32LittleCtr6 = 0U; u32LittleCtr6 < 4U; u32LittleCtr6++) {
					...
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					CA_Check2(&pcoau8StrA6[u32LittleCtr6], &pcoau8StrB6[u32LittleCtr6], sizeof(*pcoau8StrA6));
#endif
					/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required
					 * Rule 17.4 */
					s32Result6 = (int32_t)pcoau8StrA6[u32LittleCtr6] - (int32_t)pcoau8StrB6[u32LittleCtr6];
					if (s32Result6 != 0) {
						/** @violates @ref AutoLibc_REF_5 MISRA 2004 Required
						 * Rule 14.7 */
			...
			} else { /* integers are identical */
				/* need check for '\0' byte in one of integers */
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				if ((0U == (pcoau32StrA6[u32Ctr6] & 0xFF000000U)) || (0U == (pcoau32StrA6[u32Ctr6] & 0x00FF0000U)) ||
					(0U == (pcoau32StrA6[u32Ctr6] & 0x0000FF00U)) || (0U == (pcoau32StrA6[u32Ctr6] & 0x000000FFU))) {
					/** @violates @ref AutoLibc_REF_5 MISRA 2004 Required
					 * Rule 14.7 */
					return 0; /* string end found, strings are identical */
				}
	...
	} else if (0U == (u8ShiftDif & 1U)) { /* Compare along 2B */
		/* first unaligned byte */
		/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
		/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
		if (0U != ((uaddr_t)(&pcoau8StrA6[u32Ctr6]) & 1U)) { /* 0 != (address % 2U), address not aligned to 2 */
#ifdef AUTOLIB_TESTING
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			CA_Check2(&pcoau8StrA6[u32Ctr6], &pcoau8StrB6[u32Ctr6], sizeof(*pcoau8StrA6));
		...
		u32Ctr6		 = 0U;
		while (1) { /* multiple return statements are used to leave the loop */
#ifdef AUTOLIB_TESTING
			/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
			/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required Rule 11.4 */
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			CA_Check2((const uint8_t *)&pcoau16StrA6[u32Ctr6], (const uint8_t *)&pcoau16StrB6[u32Ctr6],
					  sizeof(*pcoau16StrA6));
#endif
			/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4 */
			if (pcoau16StrA6[u32Ctr6] != pcoau16StrB6[u32Ctr6]) { /* there is at least 1 not matching
			 byte */
				/* accessing by bytes again */
				/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required Rule 11.4
				 */
				...
				/** @violates @ref AutoLibc_REF_7 MISRA 2004 Required Rule 17.4
				 */
				if ((0U == (pcoau16StrA6[u32Ctr6] & 0xFF00U)) || (0U == (pcoau16StrA6[u32Ctr6] & 0x00FFU))) {
					/** @violates @ref AutoLibc_REF_5 MISRA 2004 Required
					 * Rule 14.7 */
					return 0; /* string end found, strings are identical */
				}
...
uint32_t fsl_strlen(const char_t pcozsStr8[]) {
	...
	/** @violates @ref AutoLibc_REF_3 MISRA 2004 Required Rule 11.3 */
	/** @violates @ref AutoLibc_REF_4 MISRA 2004 Required Rule 11.4 */
	CA_Check1((const uint8_t *)&pcozsStr8[u32Length8], sizeof(*pcozsStr8));
#endif
...
void fsl_srand(uint32_t u32Seed9) {
	...
	if (0U == u32Seed9) { /* Forbidden value */
...
/**
 * @brief Computes absolute (positive) value of s32Number
 * @details If the number has minimal possible value
 * (-鈭�9,223,372,036,854,775,808), result is undefined.
 * @param[in] s32Number Value to calculate with.
 * @return The absolute value of u32Number
 */
