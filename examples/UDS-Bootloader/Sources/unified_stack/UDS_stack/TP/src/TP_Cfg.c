...
/*
 description: the enum have not init all member. Because, different project
 maybe have different MAX_TP_NO. The enum is a global enum and value.
 */
...
boolean TP_DriverReadDataFromTP(const uint32 i_readDataLen, uint8 *o_pReadDatabuf, uint32 *o_pTxMsgID,
