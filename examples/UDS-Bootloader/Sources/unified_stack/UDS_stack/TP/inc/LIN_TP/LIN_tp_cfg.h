#ifndef __LIN_TP_CFG_H__
#define __LIN_TP_CFG_H__
...
typedef unsigned char (*tNetTxMsg)(const tUdsId, const unsigned short, const unsigned char *, const tpfNetTxCallBack,
								   const uint32);
...
extern boolean LINTP_DriverReadDataFromLINTP(const uint32 i_readDataLen, uint8 *o_pReadDataBuf,
