...
#define SF_CANFD_DATA_MAX_LEN                                                                                          \
	(62u) /*max CAN FD signle frame data                                                                               \
			  len*/
...
#define TX_SF_DATA_MAX_LEN                                                                                             \
	(SF_CAN_DATA_MAX_LEN) /*RX support CAN FD, TX message is                                                           \
							 unspport CAN FD */
...
#define TX_SF_DATA_MAX_LEN                                                                                             \
	(SF_CANFD_DATA_MAX_LEN) /*RX support CAN FD, TX message is                                                         \
							   unspport CAN FD */
...
extern boolean CANTP_DriverReadDataFromCANTP(const uint32 i_readDataLen, uint8 *o_pReadDataBuf,
