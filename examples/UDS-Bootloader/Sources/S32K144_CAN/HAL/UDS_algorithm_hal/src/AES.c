...
/**
 */
static sint32 getRight4Bit(sint32 num) { return num & 0x0000000f; }
/**
 */
...
/**
 */
static const sint32 Rcon[10] = {0x01000000, 0x02000000, 0x04000000, 0x08000000, 0x10000000,
...
static sint32 GFMul3(sint32 s) { return GFMul2(s) ^ s; }

static sint32 GFMul4(sint32 s) { return GFMul2(GFMul2(s)); }

static sint32 GFMul8(sint32 s) { return GFMul2(GFMul4(s)); }

static sint32 GFMul9(sint32 s) { return GFMul8(s) ^ s; }

static sint32 GFMul11(sint32 s) { return GFMul9(s) ^ GFMul2(s); }

static sint32 GFMul12(sint32 s) { return GFMul8(s) ^ GFMul4(s); }

static sint32 GFMul13(sint32 s) { return GFMul12(s) ^ s; }

static sint32 GFMul14(sint32 s) { return GFMul12(s) ^ GFMul2(s); }
