      ...
      <el-collapse v-model="activeName" accordion style="margin:50px">
        ...
        <el-collapse-item title="S32K2TV HSE M1|M2|M3 Generate(Legacy)" name="2">
          ...
          >
            ...
            <el-form-item label="Auth Key ID:" prop="authKeyId">
               <el-select v-model="k2she.authKeyId" placeholder="Please choose" style="width:300px" filterable>
                <el-option
            ...
            <el-form-item label="New Key ID:" prop="keyId">
              <el-select v-model="k2she.keyId" placeholder="Please choose" style="width:300px" filterable>
                <el-option
                  v-for="item in keyArray"
                  :key="item.label"
                  :label="item.label"
        ...
        <el-collapse-item title="S32K3 HSE M1|M2|M3 Generate" name="3">
          ...
          >
            ...
            <el-form-item label="Auth Key ID:" prop="authKeyId">
               <el-select v-model="k3she.authKeyId" placeholder="Please choose" style="width:300px" filterable>
                <el-option
                  v-for="item in keyArray"
                  :key="item.label"
                  :label="item.label"
            ...
            <el-form-item label="New Key ID:" prop="keyId">
              <el-select v-model="k3she.keyId" placeholder="Please choose" style="width:300px" filterable>
                <el-option
                  v-for="item in keyArray"
                  :key="item.label"
                  :label="item.label"
...
export default {
  ...
  data() {
    return {
      ...
      mma:
        "/* S32K1/K3 M1M2M3 generated by ECUBus*/\r\n",
      k1rules: {
        name: [{ required: true, message: "Please enter name of key", trigger: "blur" }],
        authKeyId: [
          {
            required: true,
            message: "Please enter the authentication key ID for verification",
            trigger: "blur",
            type: "number"
          }
        ],
        authKeyValue: [
          {
            required: true,
            pattern: /^[0-9a-fA-F]+$/,
            message: 'Please enter the authentication key for verification, e.g:"0001020304"',
            trigger: "change"
          },
          { min: 32, max: 32, message: "The key is 16 bytes", trigger: "blur" }
        ],
        keyId: [
          {
            required: true,
            message: "Please enter the key ID for verification",
            trigger: "blur",
            type: "number"
          }
        ],
        keyValue: [
          {
            required: true,
            pattern: /^[0-9a-fA-F]+$/,
            message: 'Please enter the key for verification, e.g:"0001020304"',
            trigger: "change"
          },
          { min: 32, max: 32, message: "The key is 16 bytes", trigger: "blur" }
        ],
        uid: [
          {
            required: true,
            pattern: /^[0-9a-fA-F]+$/,
            message: 'Please enter the UID for verification, e.g.:"0001020304"',
            trigger: "change"
          },
          { min: 30, max: 30, message: "UID is 15 bytes", trigger: "blur" }
        ]
      },
      k3rules: {
        name: [{ required: true, message: "Please enter key name", trigger: "blur" }],
        authKeyId: [
          {
            required: true,
            message: "Please enter authentication key ID for verification",
            trigger: "blur",
          }
        ],
        authKeyValue: [
          {
            required: true,
            pattern: /^[0-9a-fA-F]+$/,
            message: 'Please enter authentication key for verification, e.g:"0001020304"',
            trigger: "change"
          },
          { min: 32, max: 32, message: "The key is 16 bytes", trigger: "blur" }
        ],
        keyId: [
          {
            required: true,
            message: "Please enter key ID for verification",
            trigger: "blur",
          }
        ],
        keyValue: [
          {
            required: true,
            pattern: /^[0-9a-fA-F]+$/,
            message: 'Please enter key for verification，e.g:"0001020304"',
            trigger: "change"
          },
          { min: 32, max: 32, message: "The key is 16 bytes", trigger: "blur" }
        ],
        uid: [
          {
            required: true,
            pattern: /^[0-9a-fA-F]+$/,
            message: 'Please enter UID for verification, e.g:"0001020304"',
            trigger: "change"
          },
          { min: 16, max: 16, message: "UID is 8 bytes", trigger: "blur" }
        ]
      }
    };
  },
  methods: {
    ...
    k1Cal(formName) {
      this.mma =
        "/* S32K1 CSEC M1M2M3 generated by ECUBus*/\r\n";
    ...
    k2Cal(formName) {
      this.mma =
        "/* S32K2TV HSE M1M2M3 generated by ECUBus*/\r\n";
      this.$refs[formName].validate(valid => {
        if (valid) {
          //console.log(this.k1she)
          var a;
    ...
    k3Cal(formName) {
      this.mma =
        "/* S32K3 HSE M1M2M3 generated by ECUBus*/\r\n";
      this.$refs[formName].validate(valid => {
        if (valid) {
          //console.log(this.k1she)
          var a;
